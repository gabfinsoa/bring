...
public class Utils {
    ...
    public Utils(WebDriver driver) {
        this.driver = driver;
        this.fluentWaitElement = new FluentWait(driver).withTimeout(java.time.Duration.ofSeconds(10))
    ...
    public static String getBrand() {
        ...
        if (System.getProperty("brand") == null) {
            System.out.println("Ex.: -Dcompany=MyCompany ");
        } else {
    ...
    public static String getMode() {
        ...
        if (System.getProperty("mode") == null) {
            System.out.println("Ex.: -Dmode=Web ");
        } else {
    ...
    public static String getEnv() {
        ...
        if (System.getProperty("env") == null) {
            System.out.println("Ex.: -Denv=prd ");
        } else {
